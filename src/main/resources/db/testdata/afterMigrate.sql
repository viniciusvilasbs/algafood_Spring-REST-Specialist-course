...
insert into cozinha (id, nome) values (5, 'Alemã');
insert into cozinha (id, nome) values (6, 'Italiana');
insert into cozinha (id, nome) values (7, 'Espanhola');
...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto) values (2, 'Do Alemão', 9.50, 5, utc_timestamp, utc_timestamp, true, true);
...
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto) values (4, 'O Porcão', 12, 4, utc_timestamp, utc_timestamp, true, true);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto) values (5, 'Mamma Mia Pizzeria', 11, 6, utc_timestamp, utc_timestamp, true, true);
insert into restaurante (id, nome, taxa_frete, cozinha_id, data_cadastro, data_atualizacao, ativo, aberto) values (6, 'Viva Marid!', 6, 7, utc_timestamp, utc_timestamp, true, true);
...
(1, 'João da Silva', 'joao.ger@algafood.com', '$2a$12$UHy2xZKKknlI8w3mc51sJu/vtigUQ8OI7U8M/Sqr5B5gQWfvrsYN.', utc_timestamp),
(2, 'Maria Joaquina', 'maria.vnd@algafood.com', '$2a$12$UHy2xZKKknlI8w3mc51sJu/vtigUQ8OI7U8M/Sqr5B5gQWfvrsYN.', utc_timestamp),
(3, 'José Souza', 'jose.aux@algafood.com', '$2a$12$UHy2xZKKknlI8w3mc51sJu/vtigUQ8OI7U8M/Sqr5B5gQWfvrsYN.', utc_timestamp),
(4, 'Sebastião Martins', 'sebastiao.cad@algafood.com', '$2a$12$UHy2xZKKknlI8w3mc51sJu/vtigUQ8OI7U8M/Sqr5B5gQWfvrsYN.', utc_timestamp),
(5, 'Manoel Lima', 'manoel.loja@gmail.com', '$2a$12$UHy2xZKKknlI8w3mc51sJu/vtigUQ8OI7U8M/Sqr5B5gQWfvrsYN.', utc_timestamp),
(6, 'Debora Mendonça', 'vinytestemail+debora@gmail.com', '$2a$12$UHy2xZKKknlI8w3mc51sJu/vtigUQ8OI7U8M/Sqr5B5gQWfvrsYN.', utc_timestamp),
(7, 'Carlos Lima', 'vinytestemail+carlos@gmail.com', '$2a$12$UHy2xZKKknlI8w3mc51sJu/vtigUQ8OI7U8M/Sqr5B5gQWfvrsYN.', utc_timestamp);
